#!/usr/bin/env bash
# Bootstrap entry point for cached containers. Always downloads the
# bootstrap helpers from the configured location and runs them from a
# temporary directory.
...
script_name="bootstrap-cached-container.sh"
tmp_dir=""
